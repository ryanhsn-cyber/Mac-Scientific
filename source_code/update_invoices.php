...
$css = str_replace('</style>', '*/ </style>', $css); // just comment out print block

// Extract the invoice body
preg_match('/<div class="invoice-wrapper">(.*?)<\/div>\s*<\/body>/s', $print_content, $body_matches);
$invoice_body = '<div class="invoice-wrapper">' . $body_matches[1] . '</div>';
