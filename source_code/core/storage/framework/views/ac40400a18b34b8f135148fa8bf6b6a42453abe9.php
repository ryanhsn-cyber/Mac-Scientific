                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="p-action-button">
                              <?php if($item->item_type != 'affiliate'): ?>
                                <?php if($item->is_stock()): ?>
                                <button class="btn btn-primary m-0 a-t-c-mr" id="add_to_cart"><i class="icon-bag"></i><span><?php echo e(__('কার্টে যোগ করুন')); ?></span></button>
                                <button class="btn btn-primary m-0" id="but_to_cart"><i class="icon-bag"></i><span><?php echo e(__('এখুনি অর্ডার করুন')); ?></span></button>
                                <?php else: ?>
        ...
        <div class=" padding-top-3x mb-3" id="details">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description" type="button" role="tab" aria-controls="description" aria-selected="true"><?php echo e(__('Description')); ?></a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="specification-tab" data-bs-toggle="tab" data-bs-target="#specification" type="button" role="tab" aria-controls="specification" aria-selected="false"><?php echo e(__('Product Details')); ?></a>
                </li>
            </ul>
            <div class="tab-content card">
                ...
                <div class="tab-pane fade show p-3 p-sm-4 p-md-5 product-landing-details" id="specification" role="tabpanel" aria-labelledby="specification-tab">
                    <?php if($item->getHtmlSpecifications()): ?>
                        <?php echo $item->getHtmlSpecifications(); ?>

                    <?php else: ?>
                        <div class="text-center"><?php echo e(__('No Product Details Available')); ?></div>
                    <?php endif; ?>
                </div>
            </div>
            </div>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/source_code/core/resources/views/front/catalog/product.blade.php ENDPATH**/ ?>