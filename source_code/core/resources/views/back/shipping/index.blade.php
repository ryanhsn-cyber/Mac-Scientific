                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="steadfast_api_key" name="steadfast_api_key" placeholder="{{ __('Enter API Key') }}" value="{{ $setting->steadfast_api_key ?? '' }}">
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                            <label for="steadfast_secret_key">{{ __('Steadfast Secret Key') }}</label>
                            <input type="password" class="form-control" id="steadfast_secret_key" name="steadfast_secret_key" placeholder="{{ __('Enter Secret Key') }}" value="{{ $setting->steadfast_secret_key ?? '' }}">
                        </div>
                    </div>
