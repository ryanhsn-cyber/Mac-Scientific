...
<div class="container padding-bottom-1x mb-1">
    <div class="row">
      ...
      <div class="col-xxl-5 col-lg-6 col-md-6">
        ...
        @endphp
        <!-- Product Info-->
        <div class="col-xxl-7 col-lg-6 col-md-6 d-flex flex-column">
            <div class="details-page-top-right-content d-flex align-items-start" style="height: auto; flex-grow: 1;">
                <div class="div w-100">
            ...
            <div class="mt-4">
                ...
                <div class="row mb-4">
                    <div class="col-md-6 mb-3 mb-md-0 pr-md-2">
                        <div class="p-3 d-flex align-items-center text-left" style="border: 1px solid #e0e0e0; border-radius: 8px; background-color: #fafafa; height: 100%;">
                            <i class="fas fa-truck text-primary mr-3" style="font-size: 24px; flex-shrink: 0;"></i>
                    ...
                    <div class="col-md-6 pl-md-2">
                        <div class="p-3 d-flex align-items-center text-left" style="border: 1px solid #e0e0e0; border-radius: 8px; background-color: #fafafa; height: 100%;">
                            <i class="fas fa-shield-alt text-primary mr-3" style="font-size: 24px; flex-shrink: 0;"></i>
                            <div class="text-left w-100">
                ...
                <!-- Payment Methods -->
                <div class="payment-methods p-3 mb-4 text-left" style="border: 1px solid #e0e0e0; border-radius: 8px; background-color: #fff;">
                    <div class="font-weight-bold text-dark mb-3" style="font-size: 13px;">Payment Methods</div>
                    <div class="d-flex align-items-center justify-content-start flex-wrap" style="gap: 8px;">
