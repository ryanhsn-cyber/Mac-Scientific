                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <a href="{{isset($home_page4_banner['url1']) ? $home_page4_banner['url1'] : ''}}" class="h3-category">
                            <img class="lazy" width="400" height="400" data-src="{{asset('assets/images/'.$home_page4_banner['img1'])}}" alt="">
                        ...
                        <a href="{{isset($home_page4_banner['url2']) ? $home_page4_banner['url2'] : ''}}" class="h3-category">
                            <img class="lazy" width="400" height="400" data-src="{{asset('assets/images/'.$home_page4_banner['img2'])}}" alt="">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 middleImage">
                        <a href="{{isset($home_page4_banner['url3']) ? $home_page4_banner['url3'] : ''}}" class="h3-category">
                            <img class="lazy" width="400" height="400" data-src="{{asset('assets/images/'.$home_page4_banner['img3'])}}" alt="">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <a href="{{isset($home_page4_banner['url4']) ? $home_page4_banner['url4'] : ''}}" class="h3-category">
                            <img src="{{asset('assets/images/'.$home_page4_banner['img4'])}}" alt="" loading="lazy">
                        ...
                        <a href="{{isset($home_page4_banner['url5']) ? $home_page4_banner['url5'] : ''}}" class="h3-category">
                            <img src="{{asset('assets/images/'.$home_page4_banner['img5'])}}" alt="" loading="lazy">
                    ...
                    @foreach ($services as $service)
                        <div class="col-lg-3 col-sm-6 text-center mb-30">
                            <div class="single-service single-service2">
                                <img class="lazy" width="400" height="400" data-src="{{ asset('assets/images/'.$service->photo) }}" alt="Shipping">
                                <div class="content">
