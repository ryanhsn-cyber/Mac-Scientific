                            ...
                            <div class="hero-slider-main owl-carousel dots-inside">
                                @foreach ($sliders as $index => $slider)
                                    ...
                                    " style="position: relative;">
                                        ...
                                        @else
                                        <img src="{{ asset('assets/images/' . $encoded_slider_photo) }}?v={{ strtotime($slider->updated_at ?? 'now') }}" loading="lazy" alt="{{ $setting->title }} Banner" width="3550" height="1440" style="width: 100%; height: auto; display: block; object-fit: contain;">
                                        @endif
