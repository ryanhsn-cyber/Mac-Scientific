...
$css = preg_replace('/^(\s*)table\s*\{/m', '$1.invoice-wrapper table {', $css);
$css = preg_replace('/^(\s*)(td|th)\s*\{/m', '$1.invoice-wrapper $2 {', $css);
$css = preg_replace('/^(\s*)(td,\s*th)\s*\{/m', '$1.invoice-wrapper td, .invoice-wrapper th {', $css);
